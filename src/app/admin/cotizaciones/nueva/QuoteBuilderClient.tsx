              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1 min-w-0 space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1">
                ...
                <div className="w-full lg:w-96 flex-shrink-0">
                  <div className="sticky top-6 flex flex-col gap-6">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white shadow-lg p-6">
                      <h3 className="font-bold text-lg text-[#0A2240] mb-4 border-b border-slate-100 pb-4">Resumen</h3>
                      <CordBuilder.Summary />
                    </div>

                    {/* Checkout Action Card */}
                    <div className="rounded-2xl bg-[#0A2240] p-6 text-white shadow-xl shadow-[#0A2240]/20 flex flex-col gap-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold leading-tight">Generación Segura</h4>
                          <p className="text-xs text-slate-300 mt-1">Enlace listo para pago en línea.</p>
                        </div>
                      </div>

                      <CordBuilder.SubmitButton className="w-full bg-[#A81200] hover:bg-red-700 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg hover:shadow-red-900/50 hover:-translate-y-1 transform flex items-center justify-center gap-2 text-lg disabled:opacity-70 disabled:hover:-translate-y-0 disabled:cursor-not-allowed">
                        {isRedirecting ? (
                          <>
