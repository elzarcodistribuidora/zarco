...
export default function Footer() {
  ...
  const isCatalogo = pathname?.replace(/\/+$/, "").endsWith("/catalogo");

  return (
    <footer className="relative mt-auto bg-gradient-to-br from-brand-red to-brand-red-dark pt-20 font-[Inter,sans-serif] text-white shadow-[0_-10px_30px_rgba(0,0,0,0.1)]">
      <Reveal>
          ...
          <div className="flex flex-col items-center border-b border-white/10 pb-8 text-center md:col-span-2 md:border-b-0 md:pb-0 lg:col-span-1 lg:items-start lg:text-left">
            <Link href="/">
              ...
              <img
                ...
                className="mb-5 block h-[60px] drop-shadow-[0_4px_6px_rgba(0,0,0,0.2)] lg:h-20"
              />
            </Link>
            <div className="mb-5 inline-block self-center rounded-[20px] border border-white/40 bg-white/15 px-3.5 py-1.5 text-[0.75rem] font-extrabold tracking-[2px] text-white uppercase lg:self-start">
              Tradición desde 1992
            </div>
            <p className="mb-7 max-w-[350px] text-[0.95rem] leading-[1.7] text-white/85">
            ...
            <div className="flex gap-3">
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="flex h-[42px] w-[42px] items-center justify-center rounded-full border border-white/25 bg-white/10 transition-all hover:-translate-y-1 hover:bg-white hover:shadow-lg [&:hover_svg]:fill-brand-red"
              >
                <svg viewBox="0 0 320 512" className="h-5 w-5 fill-white transition-all">
              ...
              <a
                ...
                className="flex h-[42px] w-[42px] items-center justify-center rounded-full border border-white/25 bg-white/10 transition-all hover:-translate-y-1 hover:bg-white hover:shadow-lg [&:hover_svg]:fill-brand-red"
              >
                <svg viewBox="0 0 448 512" className="h-5 w-5 fill-white transition-all">
      ...
      <div className="border-t border-white/5 bg-black/25 py-6">
      ...
      {!isCatalogo && (
        ...
        >
          <svg viewBox="0 0 448 512" className="h-[22px] w-[19px] fill-current">
