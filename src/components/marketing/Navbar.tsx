...
export default function Navbar() {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed top-0 right-0 z-[2001] flex h-screen w-[85%] max-w-[380px] flex-col overflow-y-auto border-l border-white/10 bg-brand-navy-light/95 px-8 pt-[70px] pb-10 shadow-[-10px_0_30px_rgba(0,0,0,0.4)] backdrop-blur-2xl transition-[right] duration-300 ease-out lg:hidden ${
