...
const REGLAS = [
  ...
  { tipo: "chorizo", kw: ["chorizo", "longaniza", "chistorra"] },
  { tipo: "hamburguesa", kw: ["hamburguesa"] },
  { tipo: "pizza", kw: ["pizza"] },
  { tipo: "embutido_rebanada", kw: ["mortadela", "peperoni", "pepperoni", "salami", "pastel de pollo", "queso de puerco"] },
  { tipo: "carne_ahumada", kw: ["chuleta", "chuleton", "costilla ahumada", "ahumad", "lomo canadiense", "recorte", "roast beef", "seleccion gourmet"] },
  { tipo: "chicharron", kw: ["chicharron"] },
  ...
  { tipo: "leche", kw: ["leche", "lechita", "lala", "media crema", "vaquitas"] },
  { tipo: "flan", kw: ["flan", "chongos", "natita"] },
  { tipo: "gelatina", kw: ["gelatina", "gelatto"] },
  { tipo: "tostada", kw: ["tostada", "tostadita", "totopo"] },
  { tipo: "tortillas", kw: ["tortilla", "tortillina", "burrito"] },
  { tipo: "pan", kw: ["pan ", "bolillo", "bollo", "telera", "baguette", "media noche"] },
  { tipo: "chiles", kw: ["chile", "rajas", "jalapeñ", "jalapen", "chipotle", "serrano"] },
  { tipo: "salsa", kw: ["salsa", "catsup", "ketchup", "jugo maggi"] },
  { tipo: "mayonesa", kw: ["mayonesa"] },
  { tipo: "mostaza", kw: ["mostaza"] },
  { tipo: "mermelada", kw: ["mermelada", "miel"] },
  { tipo: "ate", kw: ["ate ", "ate de", "membrillo", "guayaba"] },
  { tipo: "cajeta", kw: ["cajeta", "dulce de leche"] },
  { tipo: "nuez", kw: ["nuez", "nueces", "almendra", "cacahuate", "pistache", "arandano", "chabacano", "datil", "higos cristalizados", "piñon", "pinon", "pepita", "semilla de girasol", "ajonjoli"] },
  { tipo: "duraznos", kw: ["durazno", "coctel de frutas", "pina en almibar", "fruta en almibar", "piña agrover", "pina agrover", "pina en trozos"] },
  { tipo: "tequila", kw: ["tequila", "mezcal"] },
  { tipo: "vino", kw: ["vino", "tinto", "blanco 750", "espumoso"] },
  { tipo: "cerveza", kw: ["cerveza", "michelada", "skyy blue"] },
  { tipo: "refresco", kw: ["boing", "refresco", "agua mineral", "jarritos", "coca", "jumex", "electrolit", "volt", "new mix", "cafe ole"] },
  { tipo: "papas", kw: ["papas", "sabritas", "frituras", "botana", "papa francesa", "papa gajo", "mccain", "chocopay", "choco amaranto", "cruji", "nachos", "galletas pretzel", "dulces tipicos"] },
  { tipo: "cigarro", kw: ["cigarro", "marlboro"] },
  { tipo: "aceituna", kw: ["aceituna"] },
  { tipo: "aceite", kw: ["aceite"] },
  { tipo: "aderezo", kw: ["aderezo"] },
  { tipo: "especia", kw: ["anis estrellado", "cilantro molido", "comino", "curcuma", "hierbas finas", "mezcla de pimientas", "azafran", "sal rosa"] },
  { tipo: "grano", kw: ["arroz", "cous cous", "fettuccini", "quinoa"] },
  { tipo: "encurtido", kw: ["cueritos", "peperoncini", "pimiento fud"] },
  { tipo: "empanizado", kw: ["nugget"] },
  { tipo: "pozole", kw: ["pozole"] },
  { tipo: "frijoles", kw: ["frijol"] },
  { tipo: "verdura", kw: ["zanahoria"] },
...
export const COMPLEMENTOS = {
  queso: ["jamon", "tocino", "tostada", "ate", "mermelada", "nuez", "vino", "crema", "chiles", "pan", "aceituna"],
  ...
  chicharron: ["chiles", "salsa", "tortillas", "cerveza"],
  hamburguesa: ["pan", "queso", "mayonesa", "mostaza", "salsa", "tocino"],
  pizza: ["queso", "salchicha", "chorizo", "salsa"],
  ...
  vino: ["queso", "nuez", "ate", "jamon", "aceituna"],
  cerveza: ["papas", "salsa", "queso"],
  refresco: ["papas", "pan"],
  papas: ["salsa", "mayonesa", "refresco", "cerveza"],
  cigarro: ["tequila", "vino", "cerveza"],
  aceituna: ["queso", "vino", "embutido_rebanada", "pan"],
  aceite: ["queso", "pan", "vino", "aceituna"],
  aderezo: ["queso", "verdura", "pan"],
  especia: ["carne_ahumada", "pechuga", "chorizo", "pozole", "tocino"],
  grano: ["queso", "aceite", "salsa", "aceituna"],
  encurtido: ["queso", "salsa", "chorizo", "tortillas"],
  empanizado: ["mayonesa", "mostaza", "salsa", "papas"],
  pozole: ["chiles", "crema", "tostada", "salsa"],
  frijoles: ["tortillas", "queso", "crema", "chorizo", "chiles"],
  verdura: ["salsa", "queso", "aceituna", "aderezo"],
